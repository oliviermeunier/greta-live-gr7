...
// Bonus avec Math.max(), spread operator et indexOf()

// Bonus avec reduce()
const longestPhrase = phrases.reduce(function(longestPhrase, phrase) {
    return phrase.length > longestPhrase.length ? phrase : longestPhrase;
}, "");

console.log(longestPhrase, longestPhrase.length);
